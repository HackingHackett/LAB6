...
based on the result of the random number, we checl to see if it falls under certain range
if the number is greater than 15, then the result will be "Cherries"
otherwise if the number is > 10, the the result wil be "Orange"
...
we iterate over using a loop three times and print the results to the user. As an examole "Plum Cherries
